...
class TheatersControllerTest < ActionController::TestCase
  ...
  test "should create theater" do
    assert_difference('Theater.count') do
      post :create, theater: { day: @theater.day, theater_name: @theater.theater_name, time: @theater.time, title_id: @theater.title_id }
    end
  ...
  test "should update theater" do
    patch :update, id: @theater, theater: { day: @theater.day, theater_name: @theater.theater_name, time: @theater.time, title_id: @theater.title_id }
    assert_redirected_to theater_path(assigns(:theater))
  end
